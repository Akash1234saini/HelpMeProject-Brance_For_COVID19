...
public final class QuaryUtils {
    ...
    private static final String TAG = QuaryUtils.class.getSimpleName();

    /**
     * Create a private constructor because no one should ever create a {@link QuaryUtils} object.
    ...
    /**
     * Query the USGS dataset and return a list of {@link LiveCoronaPatient} objects.
     */
    public static List<LiveCoronaPatient> fetchCoronaPatientData(String requestUrl) {
        // Create URL object
        ...
        // Extract relevant fields from the JSON response and create a list of {@link Patient}s
    ...
    /**
     * Return a list of {@link LiveCoronaPatient} objects that has been built up from
     * parsing the given JSON response.
     */
    private static List<LiveCoronaPatient> extractFeatureFromJson(String patientJSON) {
        ...
        List<LiveCoronaPatient> coronaPatients = new ArrayList<>();
...
//             For each corona patient country in the coronaPatientArray, create an {@link LiveCoronaPatient} object
            for (int i = 0; i < coronaPatientArray.length(); i++) {
                ...
                String country = coronaPatientArray.getJSONObject(i).getString("displayName");
            ...
            Log.e("QuaryUtils", "Problem parsing the earthquake JSON results", e);
        }
